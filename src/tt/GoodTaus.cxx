...
ROOT::RDF::RNode GoodTaus_tt (ROOT::RDF::RNode df0, OnnxSessionManager &onnxSessionManager, CorrectionManager &correctionManager) {

        auto df1 = physicsobject::CutPt(df0, "Tau_pt_corrected", "PG_internal_quantity_38", 35.0);
    auto df2 = physicsobject::CutPt(df1, "Tau_pt_corrected__tauEs3prong1pizeroDown", "PG_internal_quantity_38__tauEs3prong1pizeroDown", 35.0);
    auto df3 = physicsobject::CutPt(df2, "Tau_pt_corrected__tauEs1prong0pizeroDown", "PG_internal_quantity_38__tauEs1prong0pizeroDown", 35.0);
    auto df4 = physicsobject::CutPt(df3, "Tau_pt_corrected__tauEs3prong1pizeroUp", "PG_internal_quantity_38__tauEs3prong1pizeroUp", 35.0);
    auto df5 = physicsobject::CutPt(df4, "Tau_pt_corrected__tauEs1prong1pizeroDown", "PG_internal_quantity_38__tauEs1prong1pizeroDown", 35.0);
    auto df6 = physicsobject::CutPt(df5, "Tau_pt_corrected__tauEs1prong1pizeroUp", "PG_internal_quantity_38__tauEs1prong1pizeroUp", 35.0);
    auto df7 = physicsobject::CutPt(df6, "Tau_pt_corrected__tauEs1prong0pizeroUp", "PG_internal_quantity_38__tauEs1prong0pizeroUp", 35.0);
    auto df8 = physicsobject::CutPt(df7, "Tau_pt_corrected__tauEs3prong0pizeroDown", "PG_internal_quantity_38__tauEs3prong0pizeroDown", 35.0);
    auto df9 = physicsobject::CutPt(df8, "Tau_pt_corrected__tauEs3prong0pizeroUp", "PG_internal_quantity_38__tauEs3prong0pizeroUp", 35.0);
    ...
    auto df13 = physicsobject::tau::CutTauID(df12, "PG_internal_quantity_42", "Tau_idDeepTau2017v2p1VSjet", 4);
    auto df14 = physicsobject::tau::CutTauID(df13, "PG_internal_quantity_43", "Tau_idDeepTau2017v2p1VSe", 4);
