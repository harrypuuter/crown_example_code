...
ROOT::RDF::RNode JetCollection_tt (ROOT::RDF::RNode df0, OnnxSessionManager &onnxSessionManager, CorrectionManager &correctionManager) {

        auto df1 = jet::VetoOverlappingJets(df0, "jet_overlap_veto_mask", "Jet_eta", "Jet_phi", "p4_1", "p4_2", 0.5);
    auto df2 = jet::VetoOverlappingJets(df1, "jet_overlap_veto_mask__tauEs3prong1pizeroDown", "Jet_eta", "Jet_phi", "p4_1__tauEs3prong1pizeroDown", "p4_2__tauEs3prong1pizeroDown", 0.5);
    auto df3 = jet::VetoOverlappingJets(df2, "jet_overlap_veto_mask__tauEs1prong0pizeroDown", "Jet_eta", "Jet_phi", "p4_1__tauEs1prong0pizeroDown", "p4_2__tauEs1prong0pizeroDown", 0.5);
    auto df4 = jet::VetoOverlappingJets(df3, "jet_overlap_veto_mask__tauEs3prong1pizeroUp", "Jet_eta", "Jet_phi", "p4_1__tauEs3prong1pizeroUp", "p4_2__tauEs3prong1pizeroUp", 0.5);
    auto df5 = jet::VetoOverlappingJets(df4, "jet_overlap_veto_mask__tauEs1prong1pizeroDown", "Jet_eta", "Jet_phi", "p4_1__tauEs1prong1pizeroDown", "p4_2__tauEs1prong1pizeroDown", 0.5);
    auto df6 = jet::VetoOverlappingJets(df5, "jet_overlap_veto_mask__tauEs1prong1pizeroUp", "Jet_eta", "Jet_phi", "p4_1__tauEs1prong1pizeroUp", "p4_2__tauEs1prong1pizeroUp", 0.5);
    auto df7 = jet::VetoOverlappingJets(df6, "jet_overlap_veto_mask__tauEs1prong0pizeroUp", "Jet_eta", "Jet_phi", "p4_1__tauEs1prong0pizeroUp", "p4_2__tauEs1prong0pizeroUp", 0.5);
    auto df8 = jet::VetoOverlappingJets(df7, "jet_overlap_veto_mask__tauEs3prong0pizeroDown", "Jet_eta", "Jet_phi", "p4_1__tauEs3prong0pizeroDown", "p4_2__tauEs3prong0pizeroDown", 0.5);
    auto df9 = jet::VetoOverlappingJets(df8, "jet_overlap_veto_mask__tauEs3prong0pizeroUp", "Jet_eta", "Jet_phi", "p4_1__tauEs3prong0pizeroUp", "p4_2__tauEs3prong0pizeroUp", 0.5);
