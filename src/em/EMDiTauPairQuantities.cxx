...
ROOT::RDF::RNode EMDiTauPairQuantities_em (ROOT::RDF::RNode df0, OnnxSessionManager &onnxSessionManager, CorrectionManager &correctionManager) {
    ...
    auto df61 = quantities::dxy(df60, "dxy_2", 1, "dileptonpair", "Muon_dxy");
    auto df62 = quantities::dxy(df61, "dxy_2__eleEsResoDown", 1, "dileptonpair__eleEsResoDown", "Muon_dxy");
    auto df63 = quantities::dxy(df62, "dxy_2__eleEsScaleUp", 1, "dileptonpair__eleEsScaleUp", "Muon_dxy");
    auto df64 = quantities::dxy(df63, "dxy_2__eleEsResoUp", 1, "dileptonpair__eleEsResoUp", "Muon_dxy");
    auto df65 = quantities::dxy(df64, "dxy_2__eleEsScaleDown", 1, "dileptonpair__eleEsScaleDown", "Muon_dxy");
    auto df66 = quantities::dz(df65, "dz_2", 1, "dileptonpair", "Muon_dz");
    auto df67 = quantities::dz(df66, "dz_2__eleEsResoDown", 1, "dileptonpair__eleEsResoDown", "Muon_dz");
    auto df68 = quantities::dz(df67, "dz_2__eleEsScaleUp", 1, "dileptonpair__eleEsScaleUp", "Muon_dz");
    auto df69 = quantities::dz(df68, "dz_2__eleEsResoUp", 1, "dileptonpair__eleEsResoUp", "Muon_dz");
    auto df70 = quantities::dz(df69, "dz_2__eleEsScaleDown", 1, "dileptonpair__eleEsScaleDown", "Muon_dz");
    auto df71 = quantities::charge(df70, "q_2", 1, "dileptonpair", "Muon_charge");
    auto df72 = quantities::charge(df71, "q_2__eleEsResoDown", 1, "dileptonpair__eleEsResoDown", "Muon_charge");
    auto df73 = quantities::charge(df72, "q_2__eleEsScaleUp", 1, "dileptonpair__eleEsScaleUp", "Muon_charge");
    auto df74 = quantities::charge(df73, "q_2__eleEsResoUp", 1, "dileptonpair__eleEsResoUp", "Muon_charge");
    auto df75 = quantities::charge(df74, "q_2__eleEsScaleDown", 1, "dileptonpair__eleEsScaleDown", "Muon_charge");
    auto df76 = quantities::isolation(df75, "iso_2", 1, "dileptonpair", "Muon_pfRelIso04_all");
    auto df77 = quantities::isolation(df76, "iso_2__eleEsResoDown", 1, "dileptonpair__eleEsResoDown", "Muon_pfRelIso04_all");
    auto df78 = quantities::isolation(df77, "iso_2__eleEsScaleUp", 1, "dileptonpair__eleEsScaleUp", "Muon_pfRelIso04_all");
    auto df79 = quantities::isolation(df78, "iso_2__eleEsResoUp", 1, "dileptonpair__eleEsResoUp", "Muon_pfRelIso04_all");
    auto df80 = quantities::isolation(df79, "iso_2__eleEsScaleDown", 1, "dileptonpair__eleEsScaleDown", "Muon_pfRelIso04_all");
    auto df81 = quantities::muon::is_global(df80, "is_global_2", 1, "dileptonpair", "Muon_isGlobal");
    auto df82 = quantities::muon::is_global(df81, "is_global_2__eleEsResoDown", 1, "dileptonpair__eleEsResoDown", "Muon_isGlobal");
    auto df83 = quantities::muon::is_global(df82, "is_global_2__eleEsScaleUp", 1, "dileptonpair__eleEsScaleUp", "Muon_isGlobal");
    auto df84 = quantities::muon::is_global(df83, "is_global_2__eleEsResoUp", 1, "dileptonpair__eleEsResoUp", "Muon_isGlobal");
    auto df85 = quantities::muon::is_global(df84, "is_global_2__eleEsScaleDown", 1, "dileptonpair__eleEsScaleDown", "Muon_isGlobal");
    auto df86 = basefunctions::DefineQuantity(df85, "tau_decaymode_1", -1);
    auto df87 = basefunctions::DefineQuantity(df86, "tau_decaymode_2", -1);
    auto df88 = quantities::m_vis(df87, "m_vis", {"p4_1","p4_2"});
    auto df89 = quantities::m_vis(df88, "m_vis__eleEsResoDown", {"p4_1__eleEsResoDown","p4_2__eleEsResoDown"});
    auto df90 = quantities::m_vis(df89, "m_vis__eleEsScaleUp", {"p4_1__eleEsScaleUp","p4_2__eleEsScaleUp"});
    auto df91 = quantities::m_vis(df90, "m_vis__eleEsResoUp", {"p4_1__eleEsResoUp","p4_2__eleEsResoUp"});
    auto df92 = quantities::m_vis(df91, "m_vis__eleEsScaleDown", {"p4_1__eleEsScaleDown","p4_2__eleEsScaleDown"});
    auto df93 = quantities::pt_vis(df92, "pt_vis", {"p4_1","p4_2"});
    auto df94 = quantities::pt_vis(df93, "pt_vis__eleEsResoDown", {"p4_1__eleEsResoDown","p4_2__eleEsResoDown"});
    auto df95 = quantities::pt_vis(df94, "pt_vis__eleEsScaleUp", {"p4_1__eleEsScaleUp","p4_2__eleEsScaleUp"});
    auto df96 = quantities::pt_vis(df95, "pt_vis__eleEsResoUp", {"p4_1__eleEsResoUp","p4_2__eleEsResoUp"});
    auto df97 = quantities::pt_vis(df96, "pt_vis__eleEsScaleDown", {"p4_1__eleEsScaleDown","p4_2__eleEsScaleDown"});
    auto df98 = quantities::deltaR(df97, "deltaR_ditaupair", "p4_1", "p4_2");
    auto df99 = quantities::deltaR(df98, "deltaR_ditaupair__eleEsResoDown", "p4_1__eleEsResoDown", "p4_2__eleEsResoDown");
    auto df100 = quantities::deltaR(df99, "deltaR_ditaupair__eleEsScaleUp", "p4_1__eleEsScaleUp", "p4_2__eleEsScaleUp");
    auto df101 = quantities::deltaR(df100, "deltaR_ditaupair__eleEsResoUp", "p4_1__eleEsResoUp", "p4_2__eleEsResoUp");
    auto df102 = quantities::deltaR(df101, "deltaR_ditaupair__eleEsScaleDown", "p4_1__eleEsScaleDown", "p4_2__eleEsScaleDown");
    return df102;
