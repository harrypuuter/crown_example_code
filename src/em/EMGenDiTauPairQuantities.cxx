...
ROOT::RDF::RNode EMGenDiTauPairQuantities_em (ROOT::RDF::RNode df0, OnnxSessionManager &onnxSessionManager, CorrectionManager &correctionManager) {

        auto df1 = ditau_pairselection::buildgenpair(df0, "dileptonpair", "Electron_genPartIdx", "Muon_genPartIdx", "gen_dileptonpair");
    auto df2 = ditau_pairselection::buildgenpair(df1, "dileptonpair__eleEsResoDown", "Electron_genPartIdx", "Muon_genPartIdx", "gen_dileptonpair__eleEsResoDown");
    auto df3 = ditau_pairselection::buildgenpair(df2, "dileptonpair__eleEsScaleUp", "Electron_genPartIdx", "Muon_genPartIdx", "gen_dileptonpair__eleEsScaleUp");
    auto df4 = ditau_pairselection::buildgenpair(df3, "dileptonpair__eleEsResoUp", "Electron_genPartIdx", "Muon_genPartIdx", "gen_dileptonpair__eleEsResoUp");
    auto df5 = ditau_pairselection::buildgenpair(df4, "dileptonpair__eleEsScaleDown", "Electron_genPartIdx", "Muon_genPartIdx", "gen_dileptonpair__eleEsScaleDown");
