...
ROOT::RDF::RNode GoodElectrons_ee (ROOT::RDF::RNode df0, OnnxSessionManager &onnxSessionManager, CorrectionManager &correctionManager) {
    ...
    auto df7 = physicsobject::electron::CutIsolation(df6, "PG_internal_quantity_9", "Electron_pfRelIso03_all", 0.3);
